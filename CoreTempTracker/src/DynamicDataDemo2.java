...
public class DynamicDataDemo2 extends ApplicationFrame
{
		...
		implements ActionListener
	{
		...
		{
			jfreechart = ChartFactory.createTimeSeriesChart("Core Temperature (zoomed)", "Time", "Value", xydataset, true, true, false);
			xyplot = (XYPlot)jfreechart.getPlot();
			valueaxis = xyplot.getDomainAxis();
			valueaxis.setAutoRange(true);
			valueaxis.setFixedAutoRange(3000000D);
		...
		public void actionPerformed(ActionEvent actionevent)
		{
			if (actionevent.getActionCommand().equals("ADD_DATA"))
			{
				...
				valueaxis.setRange(minAxis, maxAxis);
				series.removeAgedItems(isVisible());
			}
		}
